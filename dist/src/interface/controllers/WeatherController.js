...
var GetWeatherByCityUseCase_1 = require("../../application/GetWeatherByCityUseCase");
var WeatherController = /** @class */ (function () {
    ...
    WeatherController.prototype.getWeather = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var lat, lon, useCase, weather, error_1, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        useCase = new GetWeatherByCityUseCase_1.GetWeatherByCityUseCase(this.weatherService);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, useCase.execute(lat, lon)];
                    case 2:
                        weather = _a.sent();
    ...
    WeatherController.prototype.validateParameters = function (lat, lon) {
